...
public final class BlockEntityTypeInit {
    ...
    static {
        RAINBOW_BED = Earth2JavaMod.BLOCK_ENTITY_TYPE_REGISTRAR.register(Utils.modResourceLocationOf("rainbow_bed"), () -> BlockEntityType.Builder.of(RainbowBedBlockEntity::new, BlockInit.RAINBOW_BED.get()).build(null));
    }
