...
public class MoolipPinkDaisyFeatureRenderer<T extends MoolipEntity> extends RenderLayer<T, CowModel<T>> {
    private final BlockRenderDispatcher blockRenderer;

    public MoolipPinkDaisyFeatureRenderer(RenderLayerParent<T, CowModel<T>> renderLayerParent, BlockRenderDispatcher blockRenderDispatcher) {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int light, T entity, float f, float g, float h, float j, float k, float l) {
        if (!entity.isBaby()) {
            ...
            if (!entity.isInvisible() || bl) {
                ...
                BlockState blockState = BlockInit.PINK_DAISY.get().defaultBlockState();
    ...
    private void renderPinkDaisyBlock(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, boolean bl, BlockState blockState, int j, BakedModel bakedModel) {
        if (bl) {
